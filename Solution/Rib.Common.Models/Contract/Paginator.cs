    ...
    public class Paginator : IPaginator
    {
        ...
        public int PageNumber
        {
            ...
            set
            {
                if (value <= 0)
                {
                    throw new ArgumentException("Номер страницы должен быть положительным числом", nameof(value));
                }
                _pageNumber = value;
            }
        }
        ...
        public int PageSize
        {
            ...
            set
            {
                if (value <= 0)
                {
                    throw new ArgumentException("Размер страницы должен быть положительным числом", nameof(value));
                }
                _pageSize = value;
            }
        }
